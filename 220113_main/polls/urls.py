...
"""
#From phiwas/urls any http request inc to 130.240.200.71/ is forwarded here, where the first '' url is to load the webpage. 
app_name = 'polls'
urlpatterns = [
    path('', views.IndexView.as_view(), name='index'), 
    path('testing/', views.testing_plant_server, name='plant_server'),
